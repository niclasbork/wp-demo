...
document.addEventListener('DOMContentLoaded', () => {
  const sliders = document.querySelectorAll('.wp-block-demo-theme-demo-slider-block .mySwiper');
  sliders.forEach(slider => {
    ...
    const autoplayDisableOnInteraction = slider.dataset.autoplayDisableOnInteraction === 'true';
    const swiperConfig = {
    ...
    new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(slider, swiperConfig);
  });
});
})();
